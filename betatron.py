...
# Start the visualization eda again
fig, ax = plt.subplots(2, 3, 2,figsize=(12, 12))
...
dataset_original = pd.read_csv('/mnt/data/Train.csv')
...
categorical_cols = ['District', 'Block', 'District_Block', 'Land_Cluster', 'SeedlingsPerPit_Binned', 'NoFertilizerAppln_Binned']
...
# Train the model
lgbm_model.fit(X_train, y_train, eval_set=[(X_test, y_test)], eval_metric='rmse', early_stopping_rounds=10, categorical_feature=categorical_cols)
